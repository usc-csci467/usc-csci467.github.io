...
{% capture hw0 %}{% include hw.html sem="spring2025" num=0 %}{% endcapture %}
{% capture hw1 %}{% include hw.html sem="spring2025" num=1 %}{% endcapture %}
{% capture hw2 %}{% include hw.html sem="spring2025" num=2 %}{% endcapture %}
{% capture hw3 %}{% include hw.html sem="spring2025" num=3 %}{% endcapture %}
{% capture hw4 %}{% include hw.html sem="spring2025" num=4 %}{% endcapture %}


**Quick Links:**
* **[Lecture Notes](/assets/spring2025/notes.pdf)**
...
* We have released three practice final exams: Final 1 ([problems](/assets/spring2025/exams/final_1.pdf), [solutions](/assets/spring2025/exams/final_1_solutions.pdf)), Final 2 ([problems](/assets/spring2025/exams/final_2.pdf), [solutions](/assets/spring2025/exams/final_2_solutions.pdf)), and Final 3 ([problems](/assets/spring2025/exams/final_3.pdf), [solutions](/assets/spring2025/exams/final_3_solutions.pdf)).
* We have released three practice midterm exams: Midterm 1 ([problems](/assets/spring2025/exams/midterm_1.pdf), [solutions](/assets/spring2025/exams/midterm_1_solutions.pdf)), Midterm 2 ([problems](/assets/spring2025/exams/midterm_2.pdf), [solutions](/assets/spring2025/exams/midterm_2_solutions.pdf)), and Midterm 3 ([problems](/assets/spring2025/exams/midterm_3.pdf), [solutions](/assets/spring2025/exams/midterm_3_solutions.pdf)).
...
<div class="staff-photo" markdown=1>
![Steven Shi](/assets/spring2025/images/steven.jpg)  
**Steven Shi**  
Course Producer
</div>
<div class="staff-photo" markdown=1>
![Ryan Wang](/assets/spring2025/images/ryan.jpg)  
**Ryan Wang**  
Course Producer
</div>
<div class="staff-photo" markdown=1>
![Alice Wei](/assets/spring2025/images/alice.jpg)  
**Alice Wei**  
Course Producer
</div>
...
|--|--|--|--|
|Tue Jan 14|Introduction ([slides](/assets/spring2025/lectures/01_intro.pdf)) |PML 1| Homework 0 released {{ hw0 | strip_newlines }}
|Thu Jan 16|Linear Regression ([demo](https://colab.research.google.com/drive/11hdXd0C7GGrxpJlC-PV6eImcWJ3Bk_Q2)) |PML 7.8, 8.2|
|Fri Jan 17|Section: Review of Probability & Linear Algebra ([notes](https://hackmd.io/@charlotteTYC/prerequisites), [section](/assets/spring2025/spring2024/sections/section1.pdf)) [](){: .schedule-section} | |
...
|Tue Feb 4 | Generative Classifiers, Naive Bayes ([slides](/assets/spring2025/lectures/07_naivebayes.pdf))  |PML 9.3-9.4 |
...
|Thu Feb 13|Introduction to Neural Networks ([slides](/assets/spring2025/lectures/10_neuralnets.pdf)) |PML 13.1-13.2 | Homework 2 released {{ hw2 | strip_newlines }}
|Fri Feb 14|Section: Cross-Validation, Evaluation Metrics ([section](/assets/spring2025/spring2024/sections/section4.pdf)) [](){: .schedule-section}| | 
|Tue Feb 18|Backpropagation ([lecture](/assets/spring2025/lectures/11_backprop.pdf), demo [part 1](/assets/spring2025/backprop/part1_forward_only.py), [part 2](/assets/spring2025/backprop/part2_trees.py), [part 3](/assets/spring2025/backprop/part3_dags.py)) |PML 13.3 | **Project Proposal due** |
|Thu Feb 20|Neural Network Optimizers, Dropout, Early Stopping ([slides](/assets/spring2025/lectures/12_nnoptim.pdf)) | PML 8.4, 13.4-13.5|
...
|Tue Feb 25|Convolutional Neural Networks ([slides](/assets/spring2025/lectures/13_convnets.pdf))  |PML 14.1-14.2 |
|Thu Feb 27|Embedding models, Word Vectors ([slides](/assets/spring2025/lectures/14_wordvec.pdf))  |PML 20.5|
...
|Tue Mar 4 |Recurrent Neural Networks ([slides](/assets/spring2025/lectures/15_rnns.pdf)) |PML 15.1-15.2 |
|Thu Mar 6 |Sequence-to-sequence, Attention ([slides](/assets/spring2025/lectures/16_attention.pdf)) |PML 15.4 | **Homework 2 due** |
...
|Tue Mar 11|Decision Trees, ensembles ([slides](/assets/spring2025/lectures/17_trees.pdf)) |PML 18.1-18.5 | 
...
|Tue Mar 25|Transformers I ([slides](/assets/spring2025/lectures/18_transformers.pdf)) |PML 15.5-15.6| Homework 3 released {{ hw3 | strip_newlines }}
|Thu Mar 27|Transformers II, Pretraining ([slides](/assets/spring2025/lectures/19_transformers2.pdf)) |PML 15.7 |
...
|Tue Apr 22|Finishing RL; Adversarial Examples ([slides](/assets/spring2025/lectures/26_adversarial.pdf)) |PML2 19.1-19.8 |
|Thu Apr 24|Spurious Correlations, Fairness in Machine Learning ([slides](/assets/spring2025/lectures/27_fairness.pdf)) | FAML 1-4 | 
|Fri Apr 25|Section: Reading NeRF paper ([link](https://arxiv.org/abs/2003.08934)) [](){: .schedule-section}| 
|Tue Apr 29|How does ChatGPT work? ([slides](/assets/spring2025/lectures/28_chatgpt.pdf)) | 
|Thu May 1 |Conclusion ([slides](/assets/spring2025/lectures/29_conclusion.pdf)) | | **Homework 4 due** |
...
## Resources
I have written **[Lecture Notes](/assets/spring2025/notes.pdf)** that accompany all the iPad lectures.
